...
Por lo tanto, es una interfaz funcional y susceptible de ser usada mediante
funciones anónimas y expresiones lambda.

Antes de Java 8, al no estar implementado todavía el cálculo lambda, era
práctica común definir el criterio de comparación a través de un objeto con
clase anónima, de la siguiente forma:
...
### Operaciones finales find y match
